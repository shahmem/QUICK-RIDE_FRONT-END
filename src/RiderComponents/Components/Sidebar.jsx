...
function Sidebar() {
  ...
  return (
     <div className={`flex flex-col h-[91vh] fixed left-0 bottom-0 bg-slate-200 px-4 py-3 md:px-12 z-30 md:py-12 justify-between text-sm transition-all transform duration-300 `}>
              <div onClick={()=>{navigate('/riderbookings')}} className='flex flex-col group  items-center rounded-3xl p-6 gap-1 hover:bg-slate-100'>
              ...
              <div  onClick={()=>{navigate('/riderhistory')}} className='flex flex-col group  items-center rounded-3xl p-6 gap-1 hover:bg-slate-100'>
                <FontAwesomeIcon className='md:size-6' icon={faClipboardList} />
                <div className="absolute  text-black text-center p-0.5 mt-12 opacity-0 group-hover:opacity-100 text-xs transition-opacity duration-300">
                History
                </div>
              </div>
              <div  onClick={()=>{navigate('/ridertransaction')}} className='flex flex-col group  rounded-3xl p-6 items-center gap-1 hover:bg-slate-100'>
